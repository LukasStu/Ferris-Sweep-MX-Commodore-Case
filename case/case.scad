...
module power_switch_slider() {
  difference() {
    union() {
      ...
      extrude_layer(L_pwr_body_overhang, z= z_bottom_gap, h=bottom_gap+kailh_sockets_thickness+fr4_thickness-MSK_thickness-compressed_gasket_thickness);
      extrude_layer(L_pwr_body, z= z_switchplate_foam-MSK_thickness-compressed_gasket_thickness, h=MSK_thickness+compressed_gasket_thickness+1);
      
    }
    extrude_layer(L_pwr_knob_cutout, z= z_switchplate_foam - MSK_thickness-compressed_gasket_thickness,  h=MSK_thickness+compressed_gasket_thickness+1);
